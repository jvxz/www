...
<template>
  <div class="relative flex h-full w-full flex-col items-start justify-start bg-[#FEFCFB] p-20">
    <h1 class="text-left text-7xl font-bold text-[#111111]" style="display: block; line-clamp: 2; text-overflow: ellipsis;">
      {{ title }}
    </h1>
    <div class="absolute top-26.5 right-26.5 size-16 rounded-full bg-[#EA9685]" />
    <h1 class="text-left text-5xl font-bold text-[#111111]/50" style="display: block; line-clamp: 2; text-overflow: ellipsis;">
      Jamie Jacobs
    </h1>
